...
▀  ▀▀▀ ▀ ▀ ▀▀ ▀▀ ▀ ▀▀▀ ▀▀   ▀▀▀    ▀   ▪
        ...
        igni: ass bomber (spammer)

  """
  _phone = input(logo+"\033[34mnumber phone>> \033[0m")
  ...
  email = _email
  os.system('cls' if os.name=='nt' else 'clear')
  print(logo+"\033[37mTelephone: \033[34m"+_phone+"\n\033[37mSpammer launched.\033[0m\n")
  while True:
    try:
      try:
      ...
      try:
        ...
        pass
      iteration += 1
      print(("\033[37m{} circle passed.\033[0m").format(iteration))
    except KeyboardInterrupt:
      os.system('cls' if os.name=='nt' else 'clear')
      print(logo+"\033[37m Telephone: \033[34m"+_phone+"\n\033[37mSpammer stopped.\033[0m")
      time.sleep(2)
      main()
main()
